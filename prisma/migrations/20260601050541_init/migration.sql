...
ALTER TABLE `user` DROP PRIMARY KEY,
    ...
    MODIFY `role` ENUM('ADMIN', 'CUSTOMER', 'SELLER') NOT NULL,
    ADD PRIMARY KEY (`id`);
...
CREATE TABLE `Product` (
    `id` VARCHAR(191) NOT NULL,
    `name` VARCHAR(191) NOT NULL,
    `category` ENUM('FASHION', 'ELECTRONICS', 'HOME', 'HEALTH', 'SPORTS', 'TOYS') NOT NULL,
...
CREATE TABLE `CartItem` (
    ...
    UNIQUE INDEX `CartItem_customerId_key`(`customerId`),
